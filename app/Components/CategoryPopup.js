...
const CategoryPopup = ({setIsHovered}) => {
    return (
        <>
             <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => {setIsHovered(false)}} className={`bg-white text-black absolute h-screen z-[9999] px-5 space-y-4 text-start md:text-center  w-[14.5rem] shadow-lg top-[3.5rem] left-0`}>
                <hr />
                { 
