  ...
  const restBanners = banners.slice(1);
    ...
    return (
        <div className="grid  grid-cols-1 gap-5 md:grid-cols-4 lg:grid-cols-9">
            ...
            {/* right banner */}
            <div className={`col-span-3 flex flex-col-reverse items-center p-5 space-y-5 bg-${banners[0].background_color} relative rounded-md md:col-span-1  md:flex-col md:justify-start md:items-start lg:col-span-2`}>
